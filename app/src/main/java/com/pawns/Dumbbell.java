...
public class Dumbbell extends Pawn {
    ...
    public Dumbbell() {
        ...
        this.attack1 = new AttackSize("Lifting", R.drawable.highlighting_attack, (byte) 1, (byte) 1);
        this.attack2 = new AttackSpeed("Leaping", R.drawable.highlighting_attack, (byte) 1, (byte) 1);
